 ...
 return (
   <div id="wd-course-status" style={{ width: "350px" }}>
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       ...
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <BsHouse className="me-2 fs-5" /> Choose Home Page </Button>
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <BiBarChart className="me-2 fs-5" /> View Course Stream </Button>
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <GiMegaphone className="me-2 fs-5" /> New Announcement </Button>
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <BiBarChart className="me-2 fs-5" /> New Analytics </Button>
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
